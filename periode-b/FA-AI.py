...
naam = "Constantijn van Hartesveldt, 10"
klas = "v1b"
studentnummer = 1848569
...
1.  Sorteeralgoritme
    ...
    1a. Handmatig toepassen
        ...
        wissel [2] en [3] [3,1,2,4] [3] gaat niet meer schuiven
        wissel [0] en [1] [1,3,2,4]
...
def my_sort(lst):
    ...
    # bubblesort
    for iter_num in range(len(lst_sorted)-1,0,-1):
      for g in range(iter_num):
         if lst_sorted[g]>lst_sorted[g+1]:
            tmp = lst_sorted[g]
            lst_sorted[g] = lst_sorted[g+1]
            lst_sorted[g+1] = tmp
...
def linear_search_recursive(lst, target):
    ...
    """
    #https://nl.wikipedia.org/wiki/Lineair_zoeken https://stackoverflow.com/a/38311392/15070611
    ...
    return linear_search(lst,len(lst),target)
